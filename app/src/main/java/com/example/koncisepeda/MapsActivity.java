        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    mMap.addMarker(new MarkerOptions().position(latLng).title("Posisi Sepeda : "+latitude + " , " + longitude));
                    mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));
                    mMap.animateCamera( CameraUpdateFactory.zoomTo( 15.80f ) );
...
//        LatLng sydney = new LatLng(-8.293809, 114.245546);
